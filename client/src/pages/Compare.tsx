...
import { ArrowRight, Check, Minus, Trash2 } from "lucide-react";
...
export default function Compare() {
  const { ids, remove, clear, max } = useComparison();
