...
export const inquiries = mysqlTable("inquiries", {
  ...
  destinationCity: varchar("destinationCity", { length: 160 }),
  destinationCountry: varchar("destinationCountry", { length: 160 }),
  destinationPort: varchar("destinationPort", { length: 160 }),
  targetMarket: varchar("targetMarket", { length: 160 }),
  timeline: varchar("timeline", { length: 120 }),
  estimatedOrderQuantity: int("estimatedOrderQuantity"),
  containerRequirement: varchar("containerRequirement", { length: 160 }),
  preferredDeliveryPeriod: varchar("preferredDeliveryPeriod", { length: 160 }),
  preferredUnits: mysqlEnum("preferredUnits", ["metric", "imperial"]),
  exportRequirements: text("exportRequirements"),
